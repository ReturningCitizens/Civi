...
class StateProvince extends AbstractDefinitionType {
	...
	public function getWhereClause($address) {
		...
		return "`country_id` = '$country_id' AND `state_province_id` = '$state_province_id'"; 
	}
	...
	public function getUserfriendlyConfiguration($definitionData) {
		...
		return E::ts('%1, %2', array(1=>$stateProvince, 2=>$country));
	}
	...
	public function getAngularTemplateUrl() {
		return '~/areas/areaDefinition/StateProvinceCtl.html';
	}
