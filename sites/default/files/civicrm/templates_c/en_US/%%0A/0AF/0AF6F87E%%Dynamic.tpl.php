<?php /* Smarty version 2.6.30, created on 2018-12-03 18:38:09
...
"><?php echo $this->_tpl_vars['cancelButtonText']; ?>
</a>
  </div>
<?php else: ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/Contact/Form/Edit/TagsAndGroups.tpl", 'smarty_include_vars' => array('type' => $this->_tpl_vars['n'],'context' => 'profile','tableLayout' => 1)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php elseif (((is_array($_tmp=$this->_tpl_vars['n'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 5) : substr($_tmp, 0, 5)) == 'phone'): ?><?php echo ''; ?><?php $this->assign('phone_ext_field', ((is_array($_tmp=$this->_tpl_vars['n'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'phone', 'phone_ext') : smarty_modifier_replace($_tmp, 'phone', 'phone_ext'))); ?><?php echo ''; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']; ?><?php echo ''; ?><?php if ($this->_tpl_vars['form'][$this->_tpl_vars['phone_ext_field']]['html']): ?><?php echo '&nbsp;'; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['phone_ext_field']]['html']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']; ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['html_type'] == 'Autocomplete-Select'): ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['data_type'] == 'ContactReference'): ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo '</div><div class="clear"></div></div>'; ?><?php if ($this->_tpl_vars['form'][$this->_tpl_vars['n']]['type'] == 'file'): ?><?php echo '<div class="crm-section file_displayURL-section file_displayURL'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '-section"><div class="content">'; ?><?php echo $this->_tpl_vars['customFiles'][$this->_tpl_vars['n']]['displayURL']; ?><?php echo '</div></div><div class="crm-section file_deleteURL-section file_deleteURL'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '-section"><div class="content">'; ?><?php echo $this->_tpl_vars['customFiles'][$this->_tpl_vars['n']]['deleteURL']; ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['field']['help_post'] && $this->_tpl_vars['action'] != 4 && $this->_tpl_vars['form'][$this->_tpl_vars['n']]['html']): ?><?php echo '<div class="crm-section helprow-'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '-section helprow-post" id="helprow-'; ?><?php echo $this->_tpl_vars['n']; ?><?php echo '"><div class="content description">'; ?><?php echo $this->_tpl_vars['field']['help_post']; ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo ''; ?><?php if ($this->_tpl_vars['isCaptcha'] && ( $this->_tpl_vars['mode'] == 8 || $this->_tpl_vars['mode'] == 4 || $this->_tpl_vars['mode'] == 1 )): ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php echo ''; ?><?php if ($this->_tpl_vars['isDuplicate']): ?><?php echo '<span class="crm-button">'; ?><?php echo $this->_tpl_vars['form']['_qf_Edit_upload_duplicate']['html']; ?><?php echo '</span>'; ?><?php endif; ?><?php echo '<a class="button cancel" href="'; ?><?php echo $this->_tpl_vars['cancelURL']; ?><?php echo '"><span><i class="crm-i fa-times"></i>'; ?><?php echo $this->_tpl_vars['cancelButtonText']; ?><?php echo '</span></a></div>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['help_post'] && $this->_tpl_vars['action'] != 4): ?><?php echo '<br /><div class="messages help">'; ?><?php echo $this->_tpl_vars['help_post']; ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?>
