           ...
           <table class="display">
             <thead>
              <tr>
                ...
                <th><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Public Title<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></th>
...
<?php if (! $this->_tpl_vars['row']['is_active']): ?> disabled<?php endif; ?>">
                ...
                <td class="crmf-frontend_title crm-editable"><?php echo $this->_tpl_vars['row']['frontend_title']; ?>
</td>
                <td>
...
<?php if (! $this->_tpl_vars['row']['is_active']): ?> disabled<?php endif; ?>">
                ...
                <td><?php echo $this->_tpl_vars['row']['frontend_title']; ?>
</td>
                <td>
                  <?php if ($this->_tpl_vars['row']['created_id'] && $this->_tpl_vars['row']['created_by']): ?>
                    <a href="<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/view','q' => "reset=1&cid=".($this->_tpl_vars['row']['created_id'])), $this);?>
