...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/Inline/Email.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Page/Inline/Email.tpl', 28, false),array('function', 'crmURL', 'CRM/Contact/Page/Inline/Email.tpl', 57, false),array('modifier', 'truncate', 'CRM/Contact/Page/Inline/Email.tpl', 64, false),array('modifier', 'crmDate', 'CRM/Contact/Page/Inline/Email.tpl', 64, false),array('modifier', 'nl2br', 'CRM/Contact/Page/Inline/Email.tpl', 72, false),)), $this); ?>
 ...
 <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Email<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
      ...
      <div class="crm-content crm-contact_email">
        <?php if (! $this->_tpl_vars['item']['on_hold'] && ! $this->_tpl_vars['privacy']['do_not_email']): ?>
          <?php if ($this->_tpl_vars['mailingOutboundOption'] == 2): ?>             <a href="mailto:<?php echo $this->_tpl_vars['item']['email']; ?>
" title="<?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['item']['email'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Send email to %1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>">
