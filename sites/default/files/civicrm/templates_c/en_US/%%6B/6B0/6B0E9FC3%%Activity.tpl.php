<?php /* Smarty version 2.6.30, created on 2018-12-03 09:35:09
         compiled from CRM/Activity/Form/Activity.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Activity/Form/Activity.tpl', 1, false),array('block', 'ts', 'CRM/Activity/Form/Activity.tpl', 45, false),array('block', 'edit', 'CRM/Activity/Form/Activity.tpl', 94, false),array('function', 'help', 'CRM/Activity/Form/Activity.tpl', 87, false),array('function', 'crmURL', 'CRM/Activity/Form/Activity.tpl', 259, false),array('modifier', 'crmAddClass', 'CRM/Activity/Form/Activity.tpl', 117, false),array('modifier', 'crmDate', 'CRM/Activity/Form/Activity.tpl', 140, false),array('modifier', 'crmStripAlternatives', 'CRM/Activity/Form/Activity.tpl', 161, false),array('modifier', 'nl2br', 'CRM/Activity/Form/Activity.tpl', 161, false),array('modifier', 'json_encode', 'CRM/Activity/Form/Activity.tpl', 284, false),)), $this); ?>
...
'<?php endif; ?>?</div>
  ...
  <?php if ($this->_tpl_vars['form']['separation']): ?>
    <tr class="crm-activity-form-block-separation crm-is-multi-activity-wrapper">
      <td class="label"><?php echo $this->_tpl_vars['form']['separation']['label']; ?>
</td>
      <td><?php echo $this->_tpl_vars['form']['separation']['html']; ?>
 <?php echo smarty_function_help(array('id' => 'separation'), $this);?>
</td>
    </tr>
  <?php endif; ?>
 ...
 ?></td>
  ...
  <tr class="crm-activity-form-block-details">
    ...
    <?php if ($this->_tpl_vars['activityTypeName'] == 'Print PDF Letter'): ?>
      ...
      <?php else: ?>
      <td class="view-value">
       <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['form']['details']['html'])) ? $this->_run_mod_handler('crmStripAlternatives', true, $_tmp) : smarty_modifier_crmStripAlternatives($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <script type="text/javascript">
    CRM.$(function($) {
      var doNotNotifyAssigneeFor = '; ?>
<?php echo json_encode($this->_tpl_vars['doNotNotifyAssigneeFor']); ?>
<?php echo ';
