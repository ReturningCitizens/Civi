<?php /* Smarty version 2.6.30, created on 2018-12-04 15:30:57
         compiled from CRM/Contact/Form/Inline/Phone.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Inline/Phone.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/Inline/Phone.tpl', 37, false),array('modifier', 'crmAddClass', 'CRM/Contact/Form/Inline/Phone.tpl', 50, false),)), $this); ?>
...
" <?php if ($this->_tpl_vars['blockId'] > $this->_tpl_vars['actualBlockCount']): ?>class="hiddenElement"<?php endif; ?>>
        <td><?php echo $this->_tpl_vars['form']['phone'][$this->_tpl_vars['blockId']]['phone']['html']; ?>
&nbsp;&nbsp;<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>ext.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['form']['phone'][$this->_tpl_vars['blockId']]['phone_ext']['html'])) ? $this->_run_mod_handler('crmAddClass', true, $_tmp, 'four') : smarty_modifier_crmAddClass($_tmp, 'four')); ?>
&nbsp;</td>
        <td><?php echo $this->_tpl_vars['form']['phone'][$this->_tpl_vars['blockId']]['location_type_id']['html']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['phone'][$this->_tpl_vars['blockId']]['phone_type_id']['html']; ?>
</td>
        <td align="center" class="crm-phone-is_primary"><?php echo $this->_tpl_vars['form']['phone'][$this->_tpl_vars['blockId']]['is_primary']['1']['html']; ?>
</td>
        <td>
          <?php if ($this->_tpl_vars['blockId'] > 1): ?>
            <a class="crm-delete-inline crm-hover-button" href="#" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Delete phone<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><span class="icon delete-icon"></span></a>
          <?php endif; ?>
        </td>
    </tr>
    <?php endfor; endif; ?>
