...
"}' data-dependent-fields='["#crm-communication-pref-content"]'<?php endif; ?>>
...
?>
        ...
        <?php else: ?>
          ...
          <?php if ($this->_tpl_vars['element']['field_data_type'] == 'ContactReference' && $this->_tpl_vars['element']['contact_ref_id']): ?>
...
" title="view contact"><?php echo $this->_tpl_vars['element']['field_value']; ?>
          ...
          <?php elseif ($this->_tpl_vars['element']['field_data_type'] == 'Money'): ?>
            <div class="crm-content crm-custom-data"><?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field_value'])) ? $this->_run_mod_handler('crmMoney', true, $_tmp) : smarty_modifier_crmMoney($_tmp)); ?>
</div>
          <?php else: ?>
