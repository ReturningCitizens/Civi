<?php /* Smarty version 2.6.30, created on 2018-12-03 09:36:16
         compiled from CRM/Contact/Page/Inline/ContactInfo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/Inline/ContactInfo.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Page/Inline/ContactInfo.tpl', 28, false),array('function', 'crmURL', 'CRM/Contact/Page/Inline/ContactInfo.tpl', 40, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><div id="crm-contactinfo-content" <?php if ($this->_tpl_vars['permission'] == 'edit'): ?> class="crm-inline-edit" <?php endif; ?> data-edit-params='{"cid": "<?php echo $this->_tpl_vars['contactId']; ?>
", "class_name": "CRM_Contact_Form_Inline_ContactInfo"}'>
  <div class="crm-clear crm-inline-block-content" <?php if ($this->_tpl_vars['permission'] == 'edit'): ?>title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Edit info<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"<?php endif; ?>>
    ...
    <?php endif; ?>
      ...
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-current_employer">
          ...
          <a href="<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/view','q' => "reset=1&cid=".($this->_tpl_vars['current_employer_id'])), $this);?>
" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>view current employer<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><?php echo $this->_tpl_vars['current_employer']; ?>
      ...
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-job_title"><?php echo $this->_tpl_vars['job_title']; ?>
</div>
      </div>
      <?php endif; ?>
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-nick_name"><?php echo $this->_tpl_vars['nick_name']; ?>
</div>
      </div>
      ...
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-legal_name"><?php echo $this->_tpl_vars['legal_name']; ?>
</div>
      </div>
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact-sic_code"><?php echo $this->_tpl_vars['sic_code']; ?>
</div>
      </div>
      <?php endif; ?>
      <div class="crm-summary-row">
        ...
        <div class="crm-content crm-contact_source"><?php echo $this->_tpl_vars['source']; ?>
</div>
      </div>
