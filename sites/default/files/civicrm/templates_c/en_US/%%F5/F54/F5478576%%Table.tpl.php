<?php /* Smarty version 2.6.30, created on 2018-11-21 14:55:48
...
/if<?php echo $this->_tpl_vars['r']; ?>
                    ...
                    <?php echo $this->_tpl_vars['l']; ?>
if $rowid neq 0<?php echo $this->_tpl_vars['r']; ?>

                      <?php if ($this->_tpl_vars['section']['pageBreak']): ?>
                        <?php echo $this->_tpl_vars['l']; ?>
if $pageBroke >= <?php echo $this->_tpl_vars['h']; ?>
 or $pageBroke == 0<?php echo $this->_tpl_vars['r']; ?>
...
/if<?php echo $this->_tpl_vars['r']; ?>
                        ...
                        <?php echo $this->_tpl_vars['l']; ?>
assign var=pageBroke value=<?php echo $this->_tpl_vars['h']; ?>
<?php echo $this->_tpl_vars['r']; ?>
...
"><th colspan="<?php echo $this->_tpl_vars['columnCount']; ?>
">
...
?>
                    ...
                    <?php $this->assign('fieldClass', ((is_array($_tmp=$this->_tpl_vars['field'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_class') : smarty_modifier_cat($_tmp, '_class'))); ?>
...
"  <?php if ($this->_tpl_vars['row'][$this->_tpl_vars['fieldClass']]): ?> class="<?php echo $this->_tpl_vars['row'][$this->_tpl_vars['fieldClass']]; ?>
"<?php endif; ?>>
                        <?php endif; ?>
