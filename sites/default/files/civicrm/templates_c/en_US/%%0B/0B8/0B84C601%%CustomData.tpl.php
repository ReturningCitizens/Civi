<?php /* Smarty version 2.6.30, created on 2018-12-03 09:35:23
         compiled from CRM/Custom/Form/CustomData.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Custom/Form/CustomData.tpl', 1, false),array('block', 'ts', 'CRM/Custom/Form/CustomData.tpl', 44, false),array('function', 'crmKey', 'CRM/Custom/Form/CustomData.tpl', 76, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 crm-accordion-wrapper crm-custom-accordion <?php if ($this->_tpl_vars['cd_edit']['collapse_display'] && ! $this->_tpl_vars['skipTitle']): ?>collapsed<?php endif; ?>">
      ...
      <div class="crm-accordion-body">
        <?php if ($this->_tpl_vars['cd_edit']['is_multiple'] == 1 && $this->_tpl_vars['cd_edit']['table_id'] && $this->_tpl_vars['contactId'] && ! $this->_tpl_vars['skipTitle'] && $this->_tpl_vars['cd_edit']['style'] == 'Inline'): ?>
