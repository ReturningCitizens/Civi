...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://easynice:@127.0.0.1/c9?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://easynice:@127.0.0.1:3306/c9?new_link=true');
  }
}
...
$civicrm_root = '/home/ubuntu/workspace/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/ubuntu/workspace/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://civi-easynice.c9users.io:80/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'd575deee74455497c130504891dea1d4');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/ubuntu/workspace/sites/default/files/civicrm/templates_c//mail.log');
// }
